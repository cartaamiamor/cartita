...
> **Origen:** descargada de [`msrbuilds/animate-css-skill`](https://github.com/msrbuilds/animate-css-skill/blob/main/animate-css-skill/SKILL.md) el 2026-08-20, junto con el asset embebido `assets/animate.min.css`. Licencia: el skill en sí se declara MIT; el CSS embebido de Animate.css v4.1.1 está licenciado aparte bajo la [Hippocratic License](https://firstdonoharm.dev/) del proyecto original [`animate.css`](https://animate.style/) — revisar sus términos antes de redistribuir el CSS. Contenido sin modificar respecto al original.
