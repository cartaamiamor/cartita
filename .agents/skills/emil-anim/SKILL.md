...
> **Origen:** descargada de un [gist público de `corysimmons`](https://gist.github.com/corysimmons/1e2f64603ae234602f92dafe2b549ea9) el 2026-08-20, que compila principios de animación de Emil Kowalski / [animations.dev](https://animations.dev). Licencia: no declarada explícitamente en el gist (uso como referencia interna; atribuir a Emil Kowalski / animations.dev como fuente de las reglas). Contenido sin modificar respecto al original.
